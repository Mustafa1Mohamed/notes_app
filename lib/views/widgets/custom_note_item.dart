...
class NoteItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  Container(
      ...
      decoration: BoxDecoration(borderRadius: BorderRadius.circular(16),color:const Color(0xffFFCD7B)),
      child:  Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text('May,22,2023',style: TextStyle(color: Colors.black.withOpacity(.5),),),
          ),
        ],
      ),
